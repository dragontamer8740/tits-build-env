...
jarsigner -verbose -keystore "../certificate.p12" -storetype PKCS12 -storepass 1234 -digestalg SHA1 \
 -sigalg MD5withRSA -tsa http://timestamp.digicert.com TiTS_AIR_x86.apk 1
